          ...
          <div className="home-hero-content">
            <h1 className="home-hero-title">
              ...
              <span className="subtitle-line">
                <span className="subtitle-text">for TailwindCSS</span>
                <sup className="version-badge">
                  v{process.env.TAILWINDCSS_SOCIAL_VERSION}
                </sup>
              </span>
            </h1>
            ...
            <div className="home-install-box">
              ...
              <CopyInstallButton text={INSTALL_COMMAND} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="home-features">
        <div className="home-features-header">
          ...
          <p className="home-features-subtitle">
            Add polished social integrations in minutes, not hours.
          </p>
        </div>
        ...
        <div className="home-features-grid">
          ...
          <div className="feature-card">
            ...
            <h3 className="feature-card-title">Tailwind CSS Native</h3>
            <p className="feature-card-description">
              Use as a plugin or standalone CSS — no framework lock-in.
            </p>
          </div>
          ...
          <div className="feature-card feature-card-lower-desktop">
          ...
          <div className="feature-card">
            ...
            <p className="feature-card-description">
              Works with Font Awesome, Heroicons, Lucide, and more.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="home-showcase-container">
          <div className="showcase-header">
            ...
            <p className="showcase-subtitle">
              All {socialProviders.length} providers across 5 distinct styles.
              Mix and match to craft the perfect buttons for your app.
            </p>
          </div>
